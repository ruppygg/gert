<div class="card card-outline card-primary">
    <div class="card-header">
        ...
        <div class="card-tools">
            ...
            <button type="button" class="btn btn-flat btn-primary" onclick="generateReport()"><span class="fas fa-file-alt"></span> Generate Report</button>
        </div>
    </div>
    <div class="card-body">
...
<script>
    ...
    function generateReport() {
        ...
        printWindow.document.write('<html><head><title>Purchase Order List</title></head><body>');
        printWindow.document.write('<h1>List of Purchase Orders</h1>');
        printWindow.document.write($('.card-body').html());
